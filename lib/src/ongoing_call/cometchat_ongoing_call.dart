...
class CometChatOngoingCall extends StatelessWidget {
   ...
   VoidCallback? onEndCallByMe,}):
        _ongoingCallController=CometChatOngoingCallController(
            callSettingsBuilder: callSettingsBuilder, sessionId: sessionId,callWorkFlow: callWorkFlow,errorHandler: onError,
        onEndCallByMe: onEndCallByMe) ,
        super(key: key);
